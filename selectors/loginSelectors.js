export const LOGIN_SELECTORS = {
  ...
  passkeyLoginButton: 'button:has-text("Passkey"), a:has-text("Passkey"), button:has-text("use a save pass key"), button:has-text("use a saved passkey"), [aria-label*="Passkey" i]',
